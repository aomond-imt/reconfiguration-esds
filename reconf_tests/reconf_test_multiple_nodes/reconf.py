...
def execute(api: Node):
    ...
    tot_reconf_time, tot_no_reconf_time, tot_sleeping_time, node_conso, comms_cons = execution_work(api, uptimes[api.node_id], reconf_periods_per_node[api.node_id], max_execution_duration)
